...
`FixtureCleanup` 和 `FixtureLifecycle` 从 Rstest 0.11.6 开始支持 named fixture builder。
...
- `FixtureCleanup`：通过 named fixture builder 注册的 cleanup callback。
- `FixtureLifecycle`：向 named fixture builder 提供 `onCleanup` 的 lifecycle 对象。
