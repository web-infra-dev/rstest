...
export interface TestContext {
  ...
  task: {
    ...
    name: string;
    /** Absolute path of the current test file when provided by the runner. Added in 0.11.0. */
    filepath?: string;
    /** Absolute path of the current project's root directory when provided by the runner. Added in 0.11.0. */
    projectRoot?: string;
