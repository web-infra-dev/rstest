...
- **也可用作：** `rstest.runOnlyPendingTimers`
- **类型：** `() => Rstest`
...
- **也可用作：** `rstest.runOnlyPendingTimersAsync`
- **类型：** `() => Promise<Rstest>`
...
- **也可用作：** `rstest.advanceTimersByTime`
- **类型：** `(ms: number) => Rstest`
...
- **也可用作：** `rstest.advanceTimersByTimeAsync`
...
- **也可用作：** `rstest.advanceTimersToNextTimer`
...
- **也可用作：** `rstest.advanceTimersToNextTimerAsync`
...
- **也可用作：** `rstest.advanceTimersToNextFrame`
- **类型：** `() => Rstest`
