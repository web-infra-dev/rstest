---
description: 本页面介绍如何配置 Rslint 内置的 Rstest rules。
---

# 配置 Rslint

[Rslint](https://github.com/web-infra-dev/rslint) 是一个兼容 ESLint 的 JavaScript 和 TypeScript linter。它内置的 `rstestPlugin` 提供了针对 Rstest 测试定义、断言、mock 和 snapshot 的 rules，可以帮助你发现常见问题。
...
如果 Rslint 发现问题，会输出 rule 名称、源码位置和类似下面的汇总信息：
