...
| ----------------------------- | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| `environment`                 | [`testEnvironment`](/config/test/test-environment)                                             | 将 `test.environmentOptions` 合并到对象形式：`testEnvironment: { name: 'jsdom', options: { ... } }`。Rstest 支持通过 Rstest environment 对象加载自定义 environment 包和 JavaScript 文件路径，包名解析时也会尝试 `rstest-environment-*`；但暂不支持文件级 `@vitest-environment` 注释。                                                                                                                                                                                               |
