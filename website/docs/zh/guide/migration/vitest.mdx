...
| ----------------------------- | ---------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `environment`                 | [`testEnvironment`](/config/test/test-environment)                                             | 将 `test.environmentOptions` 合并到对象形式：`testEnvironment: { name: 'jsdom', options: { ... } }`。Rstest 支持通过 Rstest environment 对象加载自定义 environment 包和 JavaScript 文件路径，包名解析时也会尝试 `rstest-environment-*`。自定义 environment 的迁移细节请参考 [从 Jest 或 Vitest 迁移自定义 environment](/config/test/test-environment#migrating-custom-environments)；但暂不支持文件级 `@vitest-environment` 注释。                                                                                          |
