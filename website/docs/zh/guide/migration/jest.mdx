...
| `testEnvironment`            | [`testEnvironment`](/config/test/test-environment)                                                | 如果使用了 Jest 自定义 environment，请参考 [从 Jest 或 Vitest 迁移自定义 environment](/config/test/test-environment#migrating-custom-environments)。                                                                                                                                                                                                                     |
