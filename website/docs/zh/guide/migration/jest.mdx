...
| `coverageProvider`           | [`coverage.provider`](/config/test/coverage#provider)                                          | Rstest 支持 `'istanbul'`（默认值）和 `'v8'`。如果 Node.js 测试需要 V8 coverage，可配置 `coverage.provider: 'v8'`。应当使用 `'istanbul'` 替换 `'babel'`。                                                                                                                                                                                                                 |
