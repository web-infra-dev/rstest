---
description: 本指南介绍如何使用 Rstest 测试 React 应用和组件。Rstest 支持在 Node.js、SSR 和浏览器模式下测试 React。
---
...
如果你的项目已经使用 Rsbuild，可以通过 [@rstest/adapter-rsbuild](/integration/rsbuild) 复用现有配置：
