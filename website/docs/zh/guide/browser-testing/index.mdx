...
| 配置项 / API                                                                                     | 浏览器模式下的行为                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [coverage.provider: 'v8'](/config/test/coverage#provider)                                        | 使用 Playwright provider 的 headless、非 watch Chromium 运行属于稳定支持范围。headed 和 watch 运行仍为实验性能力，不保证隔离非活跃 runner frame，也不保证 rebuild 前后的 script 与 source map 严格配对。Firefox 和 WebKit 必须使用 `istanbul`。 |
