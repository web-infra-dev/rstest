...
| 配置项 / API                                                                                     | 浏览器模式下的行为                                                                                                                                                          |
| ------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [coverage.provider: 'v8'](/config/test/coverage#provider)                                        | 使用 Chromium 和 Playwright provider 时支持。Rstest 从实际执行的浏览器产物收集原生 V8 coverage，并通过 source map 重映射，无需插桩。Firefox 和 WebKit 必须使用 `istanbul`。 |
