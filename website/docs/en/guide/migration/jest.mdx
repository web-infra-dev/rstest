...
| `testEnvironment`            | [`testEnvironment`](/config/test/test-environment)                                                                     | If you use a custom Jest environment, see [Migrating custom environments from Jest or Vitest](/config/test/test-environment#migrating-custom-environments).                                                                                                                                                                                                                                                                             |
