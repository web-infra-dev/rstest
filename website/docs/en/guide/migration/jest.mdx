...
| `coverageProvider`           | [`coverage.provider`](/config/test/coverage#provider)                                          | Rstest supports `'istanbul'` (default) and `'v8'`. Use `coverage.provider: 'v8'` for Node.js tests that need V8 coverage. `'babel'` should be replaced with `'istanbul'`.                                                                                                                                                                                                                                                               |
