...
| `testEnvironment`            | [`testEnvironment`](/config/test/test-environment)                                                                     | If you use a custom Jest environment, see [Migrating Jest custom environments](#custom-environments).                                                                                                                                                                                                                                                                                                                                   |
...
### Migrating custom environments {#custom-environments}

If your Jest project uses a custom environment, replace the class-based API with Rstest's default-exported environment object:

```diff title="Jest to Rstest custom environment"
- const NodeEnvironment = require('jest-environment-node').TestEnvironment;
-
- class CustomEnvironment extends NodeEnvironment {
-   async setup() {
-     await super.setup();
-     this.global.__MARKER__ = this.globalConfig.testEnvironmentOptions.marker;
-   }
-
-   async teardown() {
-     delete this.global.__MARKER__;
...
+     const base = await builtinEnvironments.node.setup(global, options);
...
```diff title="Jest config to Rstest config"
- module.exports = {
