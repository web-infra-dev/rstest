...
| ----------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `environment`                 | [`testEnvironment`](/config/test/test-environment)                                             | Fold `test.environmentOptions` into the object form: `testEnvironment: { name: 'jsdom', options: { ... } }`. Rstest supports custom environment packages and JavaScript file paths via a Rstest environment object. Package resolution also tries `rstest-environment-*`. For custom environment migration details, see [Migrating custom environments from Jest or Vitest](/config/test/test-environment#migrating-custom-environments). File-level `@vitest-environment` comments are temporarily not supported.                                                           |
