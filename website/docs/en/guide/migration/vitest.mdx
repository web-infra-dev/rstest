...
| ----------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `environment`                 | [`testEnvironment`](/config/test/test-environment)                                             | Fold `test.environmentOptions` into the object form: `testEnvironment: { name: 'jsdom', options: { ... } }`. Rstest supports custom environment packages and JavaScript file paths via a Rstest environment object. Package resolution also tries `rstest-environment-*`. For custom environment migration details, see [Migrating Vitest custom environments](#custom-environments). File-level `@vitest-environment` comments are temporarily not supported.                                                                                                               |
...
Rstest temporarily does not support file-level `@vitest-environment` comments. If you need per-file environment switching, use separate projects or config files for now. For more custom environment API details, see [`testEnvironment`](/config/test/test-environment#custom-environments).
