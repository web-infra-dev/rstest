---
description: This guide covers how to test React applications and components with Rstest.
---
...
If your project already uses Rsbuild, you can reuse your existing configuration with [@rstest/adapter-rsbuild](/integration/rsbuild):
