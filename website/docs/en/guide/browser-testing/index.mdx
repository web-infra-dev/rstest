...
| ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [coverage.provider: 'v8'](/config/test/coverage#provider)                                        | Stable for headless, non-watch Chromium runs with the Playwright provider. Headed and watch runs are experimental and do not guarantee isolation from inactive runner frames or exact script/source-map pairing across rebuilds. Firefox and WebKit must use `istanbul`. |
