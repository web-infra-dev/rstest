...
| ------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [coverage.provider: 'v8'](/config/test/coverage#provider)                                        | Supported with Chromium and the Playwright provider. Rstest collects native V8 coverage from the executed browser bundle and remaps it through source maps, without instrumentation. Firefox and WebKit must use `istanbul`.                                           |
