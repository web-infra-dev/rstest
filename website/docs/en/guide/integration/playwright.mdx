...
Rstest browser mode has a different target. It is designed for component and in-browser tests. Rstest bundles the test and source modules for the browser, then runs the test code inside the browser runtime.
