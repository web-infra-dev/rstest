...
In non-TTY environments, the default reporter automatically logs periodic progress updates every 30 seconds. This prevents CI "no output" timeouts (e.g., GitHub Actions kills processes after 10 minutes of silence) and provides visibility into test execution.
...
When a test case runs longer than 10 seconds, its name and elapsed time are shown. This helps identify stuck or slow tests.
