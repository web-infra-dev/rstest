...
The blob reporter serializes test results into JSON files for later merging. This is designed for use with [test sharding](/guide/basic/cli#sharding-tests) in CI environments, where tests are split across multiple machines and results need to be combined afterward.
