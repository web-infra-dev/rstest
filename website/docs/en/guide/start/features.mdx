---
description: Explore Rstest features, from fast Rspack-powered bundle execution and VM mode to build config reuse, browser testing, sharding, and coverage.
---

# Features

Rstest is a JavaScript and TypeScript testing framework built on Rsbuild and Rspack. Its bundle-based execution model speeds up testing by reducing redundant module transformation and execution. Reuse your build configuration, test in Node.js or a browser, and run local development and CI workflows with the same runner.
...
Tree Shaking removes unused code, while [lazyBarrel](https://rspack.rs/guide/optimization/lazy-barrel) skips unused re-exports in side-effect-free barrel files. By reducing unnecessary module transformation and execution, the bundle model can speed up tests in large projects with complex dependency graphs.
...
Learn more about [Playwright](/integration/playwright).
...
Learn more about [Module Federation testing](/integration/module-federation).
