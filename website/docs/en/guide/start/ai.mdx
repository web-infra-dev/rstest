...
Use this prompt to migrate an existing Jest or Vitest project to Rstest. The linked instructions inline the [migrate-to-rstest](https://github.com/rstackjs/agent-skills#migrate-to-rstest) skill end-to-end:
