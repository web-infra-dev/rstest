...
Claude Code v2.1.277 and later can read `AGENTS.md` directly. If your session [cannot load `AGENTS.md` directly](https://code.claude.com/docs/en/memory#when-agentsmd-support-is-unavailable), create a `CLAUDE.md` file that imports it:
