...
A function argument is always treated as a fixture function. To use a function as the fixture value, return it from a fixture function, for example `.extend('predicate', () => predicate)`. Use direct object destructuring in the first parameter to request other fixtures or fields from `TestContext`.
