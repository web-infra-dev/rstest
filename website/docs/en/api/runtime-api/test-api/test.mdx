...
The fixture name must be a statically known string literal so TypeScript can expose the new context field. A value typed only as `string` is not accepted by this overload.
