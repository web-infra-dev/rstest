...
`FixtureCleanup` and `FixtureLifecycle` support named fixture builders starting in Rstest 0.11.6.
...
- `FixtureCleanup`: A cleanup callback registered by a named fixture builder.
- `FixtureLifecycle`: The lifecycle object that provides `onCleanup` to a named fixture builder.
