...
1. If a factory function is provided as the second parameter to `rs.mock`, the module will be replaced with the return value of the factory function (the factory function can be async) as the implementation of the mocked module.
