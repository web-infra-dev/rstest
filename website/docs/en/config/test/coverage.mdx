...
The coverage provider to use. Rstest supports both [istanbul](https://istanbul.js.org/) and `v8`.
...
The `v8` provider collects precise coverage from the Node.js inspector, then remaps it to Istanbul format through `v8-to-istanbul`.
