...
See the [federation example](https://github.com/web-infra-dev/rstest/tree/main/examples/federation) for a complete setup with Browser Mode, HTTP remotes, local CommonJS remotes, and SSR tests.
