---
description: Browser Mode configuration. When enabled, tests run in a real browser instead of the Node.js environment.
---
...
Browser launch options still need to stay aligned across browser projects: `provider`, `browser`, `headless`, and `providerOptions`.
