---
description: Hide logs for skipped test cases to reduce noise in the test output, especially when running tests with filters.
---
...
By default, Rstest displays logs for all test cases when you use the [verbose reporter](/guide/basic/reporters#verbose-reporter).
