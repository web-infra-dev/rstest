---
description: "In-source testing is where the test code lives within the same file as the source code, similar to Rust's module tests."
---
...
`includeSource` works in both Node mode and [browser mode](/guide/browser-testing) projects.
