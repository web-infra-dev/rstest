...
Enable this configuration to include line number and column number information for test cases and suites when collecting test information. This is useful for debugging and when reporters need to collect test information.

Note that enabling this configuration will slightly impact test execution performance.
